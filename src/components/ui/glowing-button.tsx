  ...
  ({ className, children, ...props }, ref) => {
    return (
      <motion.button
        ...
        {...props}
      >
        <span className="absolute inset-0 w-full h-full -z-10 bg-gradient-to-r from-primary/60 to-secondary/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-[20px]"></span>
